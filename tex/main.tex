\documentclass[a4paper, 12pt, english]{article}
	% Change to english if english.
	% Add ', titlepage' for larger projects.
...
\usepackage{amsmath}
%\usepackage{dsfont} % does not work
...
\usepackage{parskip}
\usepackage{caption}
% \usepackage{mathabx} % adds astronomical symbols like \Sun, \Earth, \Mars, etc. didn't work

% Makes subsection numbering: 1.a), 1.b), 2.a), etc...
